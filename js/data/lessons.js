...
export const LESSONS = [
  ...
  {
    id: 'l6',
    title: "미국식 발음 핵심 — Rachel's English 스타일 IPA",
    desc: "Rachel's English가 강조하는 소리들(모음 사이 T의 [ɾ], 슈와 [ə] 약화, dark L, TH, 강세)을 IPA로 익힙니다. 받아쓰며 소리와 기호를 함께 잡으세요. 재생은 브라우저 음성(TTS)입니다.",
    level: '발음',
    sentences: [
      { id: 'l6-1', text: 'I need to get a little water.', ko: '물 좀 마셔야겠어.',
        linking: [ { span: 'get a little water', tip: '모음 사이 T는 모두 flap [ɾ]: get a little water → /ˈɡɛɾ‿ə ˈlɪɾ‿əl ˈwɔɾ‿ɚ/. 한국어 ㄹ에 가깝게 “게러 리를 워러”.' } ] },
      { id: 'l6-2', text: 'What are you doing later?', ko: '이따 뭐 해?',
        linking: [ { span: 'What are you', tip: 'What are you → /wʌɾ‿ɚ‿jə/ “와러여”. what의 T가 flap, are·you는 슈와로 약화됩니다.' }, { span: 'later', tip: 'later → /ˈleɪɾɚ/. 여기서도 T가 flap [ɾ].' } ] },
      { id: 'l6-3', text: "I can go, but I can't stay long.", ko: '가긴 하는데 오래는 못 있어.',
        linking: [ { span: 'can go', tip: '약형 can → /kən/ “큰”. 강세가 없어 거의 안 들립니다.' }, { span: "can't stay", tip: "can't → /kænt/ “캔(트)”. 모음이 완전한 [æ]로 길고 강합니다. can[kən]과 이 모음 차이로 구분하세요." } ] },
      { id: 'l6-4', text: 'Could you pass me the butter?', ko: '버터 좀 건네줄래?',
        linking: [ { span: 'Could you', tip: 'Could you → /ˈkʊdʒə/ “쿠쥬”. d + y가 [dʒ]로 구개음화됩니다.' }, { span: 'butter', tip: 'butter → /ˈbʌɾɚ/ “버러”. tt가 flap [ɾ], 끝은 r색 슈와 [ɚ].' } ] },
      { id: 'l6-5', text: "That's a really good idea.", ko: '그거 정말 좋은 생각이야.',
        linking: [ { span: 'really', tip: 'really → /ˈɹiːli/. 끝의 L은 dark L [ɫ], 혀 뒤가 올라가 “으” 색이 섞입니다.' }, { span: 'good idea', tip: 'good idea → /ɡʊd‿aɪˈdiːə/ “구다이디어”. d가 뒤 모음으로 이어지고 idea 둘째 음절에 강세.' } ] },
      { id: 'l6-6', text: "I'll think about it tomorrow.", ko: '내일 그거 생각해 볼게.',
        linking: [ { span: 'think', tip: 'think → /θɪŋk/. TH는 무성 [θ], 혀끝을 이 사이에. ŋ은 콧소리.' }, { span: 'about it', tip: 'about it → /əˈbaʊɾ‿ɪt/ “어바우릿”. 앞 슈와 약화 + T flap.' } ] },
      { id: 'l6-7', text: 'He works at a bank downtown.', ko: '그 사람은 시내 은행에서 일해.',
        linking: [ { span: 'at a', tip: 'at a → /æɾ‿ə/ “애러”. T flap으로 두 단어가 한 덩어리.' }, { span: 'downtown', tip: 'downtown → /ˌdaʊnˈtaʊn/. 강세가 둘째 음절 town에 있습니다.' } ] },
      { id: 'l6-8', text: 'The letter arrived a little late.', ko: '편지가 좀 늦게 도착했어.',
        linking: [ { span: 'letter', tip: 'letter → /ˈlɛɾɚ/ “레러”. tt는 flap [ɾ].' }, { span: 'a little late', tip: 'a little late → /ə ˈlɪɾ‿əl leɪt/. little은 flap+dark L, late의 끝 T는 개방하지 않아 거의 안 들립니다.' } ] },
      { id: 'l6-9', text: "I don't know what you mean.", ko: '무슨 말인지 모르겠어.',
        linking: [ { span: "don't know", tip: "don't know → /doʊ‿noʊ/ “도우노”. T가 N 앞에서 탈락합니다." }, { span: 'what you', tip: 'what you → /ˈwʌtʃə/ “왓츄”. t + y가 [tʃ]로 융합.' } ] },
      { id: 'l6-10', text: 'This is important and comfortable.', ko: '이건 중요하고 편해.',
        linking: [ { span: 'important', tip: 'important → /ɪmˈpɔːɹʔn̩t/ “임포어은(트)”. 둘째 T는 성문폐쇄 [ʔ]로 막고 n은 음절성.' }, { span: 'comfortable', tip: 'comfortable → /ˈkʌmftɚbəl/ “컴프터블”. 3음절로 줄고 or이 [ɚ]로 약화됩니다.' } ] },
      { id: 'l6-11', text: 'Water the plants in the morning.', ko: '아침에 화분에 물 줘.',
        linking: [ { span: 'Water', tip: 'Water → /ˈwɔːɾɚ/ “워러”. T flap + r색 슈와.' }, { span: 'in the', tip: 'in the → /ɪn ðə/. the의 TH는 유성 [ð], 슈와로 약화.' } ] },
      { id: 'l6-12', text: 'Thirty-three birds were thirsty.', ko: '서른세 마리 새가 목말라 했어.',
        linking: [ { span: 'Thirty-three', tip: 'Thirty-three → /ˈθɝːɾi θɹiː/. 무성 TH [θ] 두 번, 첫 단어 tt는 flap, ir은 r색 모음 [ɝ].' }, { span: 'thirsty', tip: 'thirsty → /ˈθɝːsti/. [θ] + [ɝ]. 한국어에 없는 소리라 특히 반복 연습.' } ] },
      { id: 'l6-13', text: 'She wanted to call you back.', ko: '그 사람이 다시 전화하려고 했어.',
        linking: [ { span: 'wanted to', tip: 'wanted to → /ˈwɑːnɪ‿ə/ “워니러/워너”. N 뒤 T가 약해지고 to가 [tə]로 축약됩니다.' }, { span: 'call you', tip: 'call you → /ˈkɔːl‿jə/. call의 dark L이 you로 이어집니다.' } ] },
      { id: 'l6-14', text: 'Turn the light off before you leave.', ko: '나가기 전에 불 꺼.',
        linking: [ { span: 'light off', tip: 'light off → /laɪɾ‿ɔːf/ “라이럽”. 모음 사이라 T가 flap [ɾ]으로 이어집니다.' }, { span: 'leave', tip: 'leave → /liːv/. 첫 L은 밝은 L, 긴 [iː] 모음.' } ] },
    ],
  },
];
